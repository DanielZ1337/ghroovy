...
import login_background from "@/public/images/login-background.jpg";
    ...
    return (
        <section className="min-h-screen flex items-stretch text-white ">
            <div className="lg:flex w-1/2 hidden bg-gray-500 relative items-center overflow-clip">
                <Image className="absolute z-0 inset-0 bg-gray-500 items-center" src={login_background}
                       alt={"clothes"}/>
            ...
            <div
                ...
                <Image className="absolute lg:hidden z-10 inset-0 bg-gray-500 items-center object-cover"
                       src={login_background} alt={"clothes"}/>
