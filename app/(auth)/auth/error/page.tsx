                ...
                <div className="grid gap-8 sm:grid-cols-2 h-full">
                    <div className="flex flex-col items-center justify-center sm:items-start md:py-24 lg:py-32">
                        ...
                        <Link href="/auth/signin"
                              className="inline-block rounded-lg bg-muted-foreground/30 px-8 py-3 text-center text-sm font-semibold text-muted-foreground outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base">
                            Try Again
                        </Link>
                    </div>
